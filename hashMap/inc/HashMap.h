...
namespace CTSL { // Concurrent Thread Safe Library
  ...
  public:
    ...
    // I need to add an iterator/linearizer/serializer/something to get a std::vector of all the contents out...
      // see find() for the basis of iteration through hashTable[]
